...
# Payout requests reserve against the same ledger balance and pending payouts
# while holding the rider row lock. This closes the concurrent double-payout
# race without adding a balance column or changing the ledger architecture.
replace_once(
...
# Cash remittance must also serialize the balance check and insert so two
# concurrent remittances cannot spend the same cash balance twice.
replace_once(
    'backend/src/modules/riders/rider-finance.service.ts',
