...
# The workflow commit step has a fixed staging list. Stage the modified regression
# here so it is included without broadening the commit to unrelated files.
