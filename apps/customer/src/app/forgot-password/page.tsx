...
export default function ForgotPassword() {
  ...
  async function submit(e: FormEvent<HTMLFormElement>) {
    ...
    try {
      const response: any = await post('/api/auth/forgot-password', {
        ...(normalizedEmail
  ...
  return (
    <main className="shell">
      <div className="card" style={{ maxWidth: 520, margin: '40px auto' }}>
        ...
        <p className="muted">
          Enter the email address or phone number associated with your ROZZI
          account. If an account matches, we&apos;ll send reset instructions.
        </p>
        ...
        <form onSubmit={submit}>
          ...
          <div className="muted" style={{ textAlign: 'center', margin: '10px 0' }}>
            OR
          </div>
